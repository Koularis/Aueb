...
public class Profile implements Serializable{
    ...
    private ArrayList<String> ongoingfR;
    ...
    public Profile(String name){
        ...
        this.ongoingfR = new ArrayList<>(); //profiles that have sent THIS profile a friend request
    ...
    public ArrayList<String> getOngoingfr(){
        return ongoingfR;
    }
